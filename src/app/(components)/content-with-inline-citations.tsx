 ...
 *
 * Renders markdown content with [Source X] citations converted to clickable badges.
...
export function ContentWithInlineCitations({
  ...
  // Convert [Source X] patterns to clickable badges after render
  ...
  useEffect(() => {
    ...
    const citationRegex = /\[(?:Source|source)\s+(\d+)\]/g;
